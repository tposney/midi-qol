...
* Templates created for instantaneous spells are removed after 1 turn or 1 second of game time.
...
* You can use ``1d4[fire]`` or ``1d4[Fire]`` when specifying a damage flavor, the first is the dnd5e internal label for the damage type, the second is whatever the localised version of the string is.
* Damage types are passed to DSN for all damage roll elements so you get coloured dice.
...
* Fix for missing css for other damage/bonus damage to leave a gap between buttons.
