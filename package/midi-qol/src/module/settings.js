...
class ConfigSettings {
	constructor() {
		...
		this.gmFastForwardSpells = false;
...
export let fetchParams = () => {
	...
	if (configSettings.gmFastForwardSpells === undefined)
		configSettings.gmFastForwardSpells = false;
	if (configSettings.fastForwardSpells === undefined)
		configSettings.fastForwardSpells = false;
	if (configSettings.accelKeysOverride === undefined)
		configSettings.accelKeysOverride = false;
