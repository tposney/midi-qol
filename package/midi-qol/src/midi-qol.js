...
import { registerSettings, fetchParams, configSettings, checkRule, enableWorkflow } from './module/settings.js';
...
import { applyTokenDamage, checkNearby, completeItemRoll, findNearby, getConcentrationEffect, getDistanceSimple, getTraitMult, MQfromActorUuid, MQfromUuid, reportMidiCriticalFlags } from './module/utils.js';
...
function setupMidiFlags() {
	...
	if (game.system.id === "dnd5e") {
		//@ts-ignore CONFIG.DND5E
		Object.values(CONFIG.DND5E.spellComponents).forEach((comp) => {
